...
// Predefined Input acceptance functions.
var (
...
// Use Text.SetWrapWidth where possible.
//
// Issue: https://github.com/malivvan/cui/issues/27
...
// example, to include a tag-like string in a box title or in a Text:
//
...
func ShortFuncName(i interface{}) string {
	return strings.TrimPrefix(runtime.FuncForPC(reflect.ValueOf(i).Pointer()).Name(), "main.(*Editor).")
}
