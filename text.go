...
// Text is a box which displays text. It implements the io.Writer interface
...
type Text struct {
	...
	// The maximum line width when wrapping (0 = use Text width).
	wrapWidth int
...
func (t *Text) set(setter func(t *Text)) *Text {
	t.mu.Lock()
	setter(t)
	t.mu.Unlock()
	return t
...
func (t *Text) get(getter func(t *Text)) {
	t.mu.RLock()
	getter(t)
	t.mu.RUnlock()
}
...
// GetTitle returns the title of this Text.
func (t *Text) GetTitle() string {
	return t.box.GetTitle()
}

// SetTitle sets the title of this Text.
func (t *Text) SetTitle(title string) *Text {
	t.box.SetTitle(title)
	return t
}

// GetTitleAlign returns the title alignment of this Text.
func (t *Text) GetTitleAlign() int {
	return t.box.GetTitleAlign()
}

// SetTitleAlign sets the title alignment of this Text.
func (t *Text) SetTitleAlign(align int) *Text {
	t.box.SetTitleAlign(align)
	return t
}

// GetBorder returns whether this Text has a border.
func (t *Text) GetBorder() bool {
	return t.box.GetBorder()
}

// SetBorder sets whether this Text has a border.
func (t *Text) SetBorder(show bool) *Text {
	t.box.SetBorder(show)
	return t
}

// GetBorderColor returns the border color of this Text.
func (t *Text) GetBorderColor() tcell.Color {
	return t.box.GetBorderColor()
}

// SetBorderColor sets the border color of this Text.
func (t *Text) SetBorderColor(color tcell.Color) *Text {
	t.box.SetBorderColor(color)
	return t
}

// GetBorderAttributes returns the border attributes of this Text.
func (t *Text) GetBorderAttributes() tcell.AttrMask {
	return t.box.GetBorderAttributes()
}

// SetBorderAttributes sets the border attributes of this Text.
func (t *Text) SetBorderAttributes(attr tcell.AttrMask) *Text {
	t.box.SetBorderAttributes(attr)
	return t
}

// GetBorderColorFocused returns the border color of this Text when focused.
func (t *Text) GetBorderColorFocused() tcell.Color {
	return t.box.GetBorderColorFocused()
}

// SetBorderColorFocused sets the border color of this Text when focused.
func (t *Text) SetBorderColorFocused(color tcell.Color) *Text {
	t.box.SetBorderColorFocused(color)
	return t
}

// GetTitleColor returns the title color of this Text.
func (t *Text) GetTitleColor() tcell.Color {
	return t.box.GetTitleColor()
}

// SetTitleColor sets the title color of this Text.
func (t *Text) SetTitleColor(color tcell.Color) *Text {
	t.box.SetTitleColor(color)
	return t
}

// GetDrawFunc returns the custom draw function of this Text.
func (t *Text) GetDrawFunc() func(screen tcell.Screen, x, y, width, height int) (int, int, int, int) {
	return t.box.GetDrawFunc()
}

// SetDrawFunc sets a custom draw function for this Text.
func (t *Text) SetDrawFunc(handler func(screen tcell.Screen, x, y, width, height int) (int, int, int, int)) *Text {
	t.box.SetDrawFunc(handler)
	return t
}

// ShowFocus sets whether this Text should show a focus indicator when focused.
func (t *Text) ShowFocus(showFocus bool) *Text {
	t.box.ShowFocus(showFocus)
	return t
}

// GetMouseCapture returns the mouse capture function of this Text.
func (t *Text) GetMouseCapture() func(action MouseAction, event *tcell.EventMouse) (MouseAction, *tcell.EventMouse) {
	return t.box.GetMouseCapture()
}

// SetMouseCapture sets a mouse capture function for this Text.
func (t *Text) SetMouseCapture(capture func(action MouseAction, event *tcell.EventMouse) (MouseAction, *tcell.EventMouse)) *Text {
	t.box.SetMouseCapture(capture)
	return t
}

// GetBackgroundColor returns the background color of this Text.
func (t *Text) GetBackgroundColor() tcell.Color {
	return t.box.GetBackgroundColor()
}

// SetBackgroundColor sets the background color of this Text.
func (t *Text) SetBackgroundColor(color tcell.Color) *Text {
	t.box.SetBackgroundColor(color)
	return t
}

// GetBackgroundTransparent returns whether the background of this Text is transparent.
func (t *Text) GetBackgroundTransparent() bool {
	return t.box.GetBackgroundTransparent()
}

// SetBackgroundTransparent sets whether the background of this Text is transparent.
func (t *Text) SetBackgroundTransparent(transparent bool) *Text {
	t.box.SetBackgroundTransparent(transparent)
	return t
}

// GetInputCapture returns the input capture function of this Text.
func (t *Text) GetInputCapture() func(event *tcell.EventKey) *tcell.EventKey {
	return t.box.GetInputCapture()
}

// SetInputCapture sets a custom input capture function for this Text.
func (t *Text) SetInputCapture(capture func(event *tcell.EventKey) *tcell.EventKey) *Text {
	t.box.SetInputCapture(capture)
	return t
}

// GetPadding returns the padding of this Text.
func (t *Text) GetPadding() (top, bottom, left, right int) {
	return t.box.GetPadding()
}

// SetPadding sets the padding of this Text.
func (t *Text) SetPadding(top, bottom, left, right int) *Text {
	t.box.SetPadding(top, bottom, left, right)
	return t
}

// InRect returns whether the given screen coordinates are within this Text.
func (t *Text) InRect(x, y int) bool {
	return t.box.InRect(x, y)
}

// GetInnerRect returns the inner rectangle of this Text.
func (t *Text) GetInnerRect() (x, y, width, height int) {
	return t.box.GetInnerRect()
}

// WrapInputHandler wraps the provided input handler function such that
// input capture and other processing of the Text is preserved.
func (t *Text) WrapInputHandler(inputHandler func(event *tcell.EventKey, setFocus func(p Widget))) func(event *tcell.EventKey, setFocus func(p Widget)) {
	return t.box.WrapInputHandler(inputHandler)
}

// WrapMouseHandler wraps the provided mouse handler function such that
// mouse capture and other processing of the Text is preserved.
func (t *Text) WrapMouseHandler(mouseHandler func(action MouseAction, event *tcell.EventMouse, setFocus func(p Widget)) (consumed bool, capture Widget)) func(action MouseAction, event *tcell.EventMouse, setFocus func(p Widget)) (consumed bool, capture Widget) {
	return t.box.WrapMouseHandler(mouseHandler)
}

// GetRect returns the rectangle occupied by this Text.
func (t *Text) GetRect() (x, y, width, height int) {
	return t.box.GetRect()
}

// SetRect sets the rectangle occupied by this Text.
func (t *Text) SetRect(x, y, width, height int) {
	t.box.SetRect(x, y, width, height)
}

// GetVisible returns whether this Text is visible.
func (t *Text) GetVisible() bool {
	return t.box.GetVisible()
}

// SetVisible sets whether this Text is visible.
func (t *Text) SetVisible(visible bool) {
	t.box.SetVisible(visible)
}

// Focus is called when this primitive receives focus.
func (t *Text) Focus(delegate func(p Widget)) {
	t.mu.Lock()
	defer t.mu.Unlock()
...
// GetFocusable returns the focusable primitive of this Text.
func (t *Text) GetFocusable() Focusable {
	return t.box.GetFocusable()
}

// Blur is called when this Text loses focus.
func (t *Text) Blur() {
	t.box.Blur()
}
...
func (t *Text) SetScrollBarVisibility(visibility ScrollBarVisibility) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) SetScrollBarColor(color tcell.Color) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) SetWordWrap(wrapOnWords bool) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) SetTextAlign(align int) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) SetVerticalAlign(valign int) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) SetTextColor(color tcell.Color) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) SetHighlightForegroundColor(color tcell.Color) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) SetHighlightBackgroundColor(color tcell.Color) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) SetBytes(text []byte) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) GetBytes(stripTags bool) []byte {
	t.mu.RLock()
	defer t.mu.RUnlock()
...
// to true, any region/color tags are stripped from the text.
func (t *Text) GetText(stripTags bool) string {
...
func (t *Text) GetBufferSize() (rows int, maxLen int) {
	t.mu.RLock()
	defer t.mu.RUnlock()
...
func (t *Text) SetDynamicColors(dynamic bool) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) SetRegions(regions bool) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
//   - You can call Text.HasFocus() from this handler.
...
func (t *Text) SetChangedFunc(handler func()) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
// handler.
func (t *Text) SetDoneFunc(handler func(key tcell.Key)) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) SetHighlightedFunc(handler func(added, removed, remaining []string)) *Text {
	t.highlighted = handler
	return t
}

func (t *Text) clipBuffer() {
	if t.maxLines <= 0 {
		return
	}
...
func (t *Text) SetMaxLines(maxLines int) *Text {
	t.maxLines = maxLines
	t.clipBuffer()
	return t
}
...
func (t *Text) ScrollTo(row, column int) {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) GetScrollOffset() (row, column int) {
	t.mu.RLock()
	defer t.mu.RUnlock()
...
func (t *Text) GetHighlights() (regionIDs []string) {
	t.mu.RLock()
	defer t.mu.RUnlock()
...
func (t *Text) SetToggleHighlights(toggle bool) *Text {
...
// is returned.
func (t *Text) GetRegionText(regionID string) string {
	t.mu.RLock()
	defer t.mu.RUnlock()
...
// When set to 0 the width of the Text is used.
func (t *Text) SetWrapWidth(width int) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) SetReindexBuffer(reindex bool) *Text {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Text) reindexBuffer(width int) {
...
func (t *Text) InputHandler() func(event *tcell.EventKey, setFocus func(p Widget)) {
...
func (t *Text) MouseHandler() func(action MouseAction, event *tcell.EventMouse, setFocus func(p Widget)) (consumed bool, capture Widget) {
