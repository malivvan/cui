...
// will allow you to establish a mapping between the Tree hierarchy and your
...
// Tree displays tree structures. A tree consists of nodes (TreeNode
...
func (t *Tree) set(setter func(t *Tree)) *Tree {
	t.mu.Lock()
	setter(t)
	t.mu.Unlock()
	return t
...
func (t *Tree) get(getter func(t *Tree)) {
	t.mu.RLock()
	getter(t)
	t.mu.RUnlock()
}
...
// GetTitle returns the title of this Tree.
func (t *Tree) GetTitle() string {
	return t.box.GetTitle()
}

// SetTitle sets the title of this Tree.
func (t *Tree) SetTitle(title string) *Tree {
	t.box.SetTitle(title)
	return t
}

// GetTitleAlign returns the title alignment of this Tree.
func (t *Tree) GetTitleAlign() int {
	return t.box.GetTitleAlign()
}

// SetTitleAlign sets the title alignment of this Tree.
func (t *Tree) SetTitleAlign(align int) *Tree {
	t.box.SetTitleAlign(align)
	return t
}

// GetBorder returns whether this Tree has a border.
func (t *Tree) GetBorder() bool {
	return t.box.GetBorder()
}

// SetBorder sets whether this Tree has a border.
func (t *Tree) SetBorder(show bool) *Tree {
	t.box.SetBorder(show)
	return t
}

// GetBorderColor returns the border color of this Tree.
func (t *Tree) GetBorderColor() tcell.Color {
	return t.box.GetBorderColor()
}

// SetBorderColor sets the border color of this Tree.
func (t *Tree) SetBorderColor(color tcell.Color) *Tree {
	t.box.SetBorderColor(color)
	return t
}

// GetBorderAttributes returns the border attributes of this Tree.
func (t *Tree) GetBorderAttributes() tcell.AttrMask {
	return t.box.GetBorderAttributes()
}

// SetBorderAttributes sets the border attributes of this Tree.
func (t *Tree) SetBorderAttributes(attr tcell.AttrMask) *Tree {
	t.box.SetBorderAttributes(attr)
	return t
}

// GetBorderColorFocused returns the border color of this Tree when focused.
func (t *Tree) GetBorderColorFocused() tcell.Color {
	return t.box.GetBorderColorFocused()
}

// SetBorderColorFocused sets the border color of this Tree when focused.
func (t *Tree) SetBorderColorFocused(color tcell.Color) *Tree {
	t.box.SetBorderColorFocused(color)
	return t
}

// GetTitleColor returns the title color of this Tree.
func (t *Tree) GetTitleColor() tcell.Color {
	return t.box.GetTitleColor()
}

// SetTitleColor sets the title color of this Tree.
func (t *Tree) SetTitleColor(color tcell.Color) *Tree {
	t.box.SetTitleColor(color)
	return t
}

// GetDrawFunc returns the custom draw function of this Tree.
func (t *Tree) GetDrawFunc() func(screen tcell.Screen, x, y, width, height int) (int, int, int, int) {
	return t.box.GetDrawFunc()
}

// SetDrawFunc sets a custom draw function for this Tree.
func (t *Tree) SetDrawFunc(handler func(screen tcell.Screen, x, y, width, height int) (int, int, int, int)) *Tree {
	t.box.SetDrawFunc(handler)
	return t
}

// ShowFocus sets whether this Tree should show a focus indicator when focused.
func (t *Tree) ShowFocus(showFocus bool) *Tree {
	t.box.ShowFocus(showFocus)
	return t
}

// GetMouseCapture returns the mouse capture function of this Tree.
func (t *Tree) GetMouseCapture() func(action MouseAction, event *tcell.EventMouse) (MouseAction, *tcell.EventMouse) {
	return t.box.GetMouseCapture()
}

// SetMouseCapture sets a mouse capture function for this Tree.
func (t *Tree) SetMouseCapture(capture func(action MouseAction, event *tcell.EventMouse) (MouseAction, *tcell.EventMouse)) *Tree {
	t.box.SetMouseCapture(capture)
	return t
}

// GetBackgroundColor returns the background color of this Tree.
func (t *Tree) GetBackgroundColor() tcell.Color {
	return t.box.GetBackgroundColor()
}

// SetBackgroundColor sets the background color of this Tree.
func (t *Tree) SetBackgroundColor(color tcell.Color) *Tree {
	t.box.SetBackgroundColor(color)
	return t
}

// GetBackgroundTransparent returns whether the background of this Tree is transparent.
func (t *Tree) GetBackgroundTransparent() bool {
	return t.box.GetBackgroundTransparent()
}

// SetBackgroundTransparent sets whether the background of this Tree is transparent.
func (t *Tree) SetBackgroundTransparent(transparent bool) *Tree {
	t.box.SetBackgroundTransparent(transparent)
	return t
}

// GetInputCapture returns the input capture function of this Tree.
func (t *Tree) GetInputCapture() func(event *tcell.EventKey) *tcell.EventKey {
	return t.box.GetInputCapture()
}

// SetInputCapture sets a custom input capture function for this Tree.
func (t *Tree) SetInputCapture(capture func(event *tcell.EventKey) *tcell.EventKey) *Tree {
	t.box.SetInputCapture(capture)
	return t
}

// GetPadding returns the padding of this Tree.
func (t *Tree) GetPadding() (top, bottom, left, right int) {
	return t.box.GetPadding()
}

// SetPadding sets the padding of this Tree.
func (t *Tree) SetPadding(top, bottom, left, right int) *Tree {
	t.box.SetPadding(top, bottom, left, right)
	return t
}

// InRect returns whether the given screen coordinates are within this Tree.
func (t *Tree) InRect(x, y int) bool {
	return t.box.InRect(x, y)
}

// GetInnerRect returns the inner rectangle of this Tree.
func (t *Tree) GetInnerRect() (x, y, width, height int) {
	return t.box.GetInnerRect()
}

// WrapInputHandler wraps the provided input handler function such that
// input capture and other processing of the Tree is preserved.
func (t *Tree) WrapInputHandler(inputHandler func(event *tcell.EventKey, setFocus func(p Widget))) func(event *tcell.EventKey, setFocus func(p Widget)) {
	return t.box.WrapInputHandler(inputHandler)
}

// WrapMouseHandler wraps the provided mouse handler function such that
// mouse capture and other processing of the Tree is preserved.
func (t *Tree) WrapMouseHandler(mouseHandler func(action MouseAction, event *tcell.EventMouse, setFocus func(p Widget)) (consumed bool, capture Widget)) func(action MouseAction, event *tcell.EventMouse, setFocus func(p Widget)) (consumed bool, capture Widget) {
	return t.box.WrapMouseHandler(mouseHandler)
}

// GetRect returns the rectangle occupied by this Tree.
func (t *Tree) GetRect() (x, y, width, height int) {
	return t.box.GetRect()
}

// SetRect sets the rectangle occupied by this Tree.
func (t *Tree) SetRect(x, y, width, height int) {
	t.box.SetRect(x, y, width, height)
}

// GetVisible returns whether this Tree is visible.
func (t *Tree) GetVisible() bool {
	return t.box.GetVisible()
}

// SetVisible sets whether this Tree is visible.
func (t *Tree) SetVisible(visible bool) {
	t.box.SetVisible(visible)
}

// Focus is called when this Tree receives focus.
func (t *Tree) Focus(delegate func(p Widget)) {
	t.box.Focus(delegate)
}

// HasFocus returns whether this Tree has focus.
func (t *Tree) HasFocus() bool {
	return t.box.HasFocus()
}

// GetFocusable returns the focusable primitive of this Tree.
func (t *Tree) GetFocusable() Focusable {
	return t.box.GetFocusable()
}

// Blur is called when this Tree loses focus.
func (t *Tree) Blur() {
	t.box.Blur()
}
...
func (t *Tree) SetCurrentNode(node *TreeNode) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
// not displayed.
func (t *Tree) SetTopLevel(topLevel int) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Tree) SetPrefixes(prefixes []string) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Tree) SetAlign(align bool) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Tree) SetGraphics(showGraphics bool) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Tree) SetSelectedTextColor(color tcell.Color) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Tree) SetSelectedBackgroundColor(color tcell.Color) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Tree) SetGraphicsColor(color tcell.Color) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Tree) SetScrollBarVisibility(visibility ScrollBarVisibility) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Tree) SetScrollBarColor(color tcell.Color) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
// a new tree node.
func (t *Tree) SetChangedFunc(handler func(node *TreeNode)) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Tree) SetSelectedFunc(handler func(node *TreeNode)) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Tree) SetDoneFunc(handler func(key tcell.Key)) *Tree {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Tree) Transform(tr Transformation) {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *Tree) InputHandler() func(event *tcell.EventKey, setFocus func(p Widget)) {
...
func (t *Tree) MouseHandler() func(action MouseAction, event *tcell.EventMouse, setFocus func(p Widget)) (consumed bool, capture Widget) {
