...
func main() {
	...
	dmScatterPlot.SetPlotType(cui.PlotTypeScatter)
	dmScatterPlot.SetMarker(cui.PlotMarkerDot)
	dmScatterPlot.SetData(scatterPlotData)
	dmScatterPlot.SetDrawYAxisLabel(false)

	bmScatterPlot := cui.NewPlot()
	...
	bmScatterPlot.SetPlotType(cui.PlotTypeScatter)
	bmScatterPlot.SetMarker(cui.PlotMarkerBraille)
