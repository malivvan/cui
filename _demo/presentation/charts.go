...
// Charts shows the chart slide.
func Charts(nextSlide func()) (title string, info string, content cui.Widget) {
	...
	// sparkline
	iowaitSparkline := cui.NewSparkline()
	...
	systemSparkline := cui.NewSparkline()
	...
	screenLayout.AddItem(firstRow, 0, 1, false)
	screenLayout.AddItem(plotRowLayout, 0, 1, false)
	...
	return "Charts", "", screenLayout
}

func newDotModeLineChart() *cui.Plot {
	dmLineChart := cui.NewPlot()
	...
	dmLineChart.SetMarker(cui.PlotMarkerDot)
