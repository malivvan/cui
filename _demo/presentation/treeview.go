...
[green]import[white] [red]"github.com/malivvan/cui"[white]

[green]func[white] [yellow]main[white]() {
	$$$

	root := cui.[yellow]NewTreeNode[white]([red]"Root"[white]).
		[yellow]AddChild[white](cui.[yellow]NewTreeNode[white]([red]"First child"[white]).
			[yellow]AddChild[white](cui.[yellow]NewTreeNode[white]([red]"Grandchild A"[white])).
			[yellow]AddChild[white](cui.[yellow]NewTreeNode[white]([red]"Grandchild B"[white]))).
		[yellow]AddChild[white](cui.[yellow]NewTreeNode[white]([red]"Second child"[white]).
			[yellow]AddChild[white](cui.[yellow]NewTreeNode[white]([red]"Grandchild C"[white])).
			[yellow]AddChild[white](cui.[yellow]NewTreeNode[white]([red]"Grandchild D"[white]))).
		[yellow]AddChild[white](cui.[yellow]NewTreeNode[white]([red]"Third child"[white]))
...
const treeBasicCode = `tree := cui.[yellow]NewTreeView[white]()`

const treeTopLevelCode = `tree := cui.[yellow]NewTreeView[white]().
		[yellow]SetTopLevel[white]([red]1[white])`

const treeAlignCode = `tree := cui.[yellow]NewTreeView[white]().
		[yellow]SetAlign[white](true)`

const treePrefixCode = `tree := cui.[yellow]NewTreeView[white]().
