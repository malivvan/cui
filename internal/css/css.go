...
func (parser *Parser) parseBOM() (bool, error) {
	if parser.nextToken().Type == TokenBOM {
		parser.shiftToken()
		return true, nil
	}
...
func (parser *Parser) shiftToken() *Token {
	var result *Token
