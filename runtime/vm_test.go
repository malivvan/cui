...
import (
	...
	"github.com/malivvan/cui/runtime/stdlib"
...
func Opts() *testopts {
	return &testopts{
		modules:     runtime.NewModuleMap(),
		symbols:     make(map[string]runtime.Object),
		maxAllocs:   -1,
		skip2ndPass: false,
	}
}
...
func (o *testopts) Symbol(name string, value runtime.Object) *testopts {
	c := o.copy()
...
func TestUndefined(t *testing.T) {
	expectRun(t, `out = undefined`, nil, runtime.UndefinedValue)
	expectRun(t, `out = undefined.a`, nil, runtime.UndefinedValue)
	expectRun(t, `out = undefined[1]`, nil, runtime.UndefinedValue)
	expectRun(t, `out = undefined.a.b`, nil, runtime.UndefinedValue)
	expectRun(t, `out = undefined[1][2]`, nil, runtime.UndefinedValue)
...
func TestBuiltinFunction(t *testing.T) {
	...
	expectRun(t, `out = int([1])`, nil, runtime.UndefinedValue)
	expectRun(t, `out = int({a: 1})`, nil, runtime.UndefinedValue)
	expectRun(t, `out = int(undefined)`, nil, runtime.UndefinedValue)
	...
	expectRun(t, `out = int(undefined, undefined)`, nil, runtime.UndefinedValue)
	...
	expectRun(t, `out = string(undefined)`, nil, runtime.UndefinedValue) // not "undefined"
	...
	expectRun(t, `out = float(true)`, nil, runtime.UndefinedValue)
	expectRun(t, `out = float(false)`, nil, runtime.UndefinedValue)
	expectRun(t, `out = float('8')`, nil, runtime.UndefinedValue)
	expectRun(t, `out = float([1,8.1,true,3])`, nil, runtime.UndefinedValue)
	expectRun(t, `out = float({a: 1, b: "foo"})`, nil, runtime.UndefinedValue)
	expectRun(t, `out = float(undefined)`, nil, runtime.UndefinedValue)
	...
	expectRun(t, `out = float(undefined, undefined)`, nil, runtime.UndefinedValue)

	expectRun(t, `out = char(56)`, nil, '8')
	expectRun(t, `out = char(1.8)`, nil, runtime.UndefinedValue)
	expectRun(t, `out = char("-52.2")`, nil, runtime.UndefinedValue)
	expectRun(t, `out = char(true)`, nil, runtime.UndefinedValue)
	expectRun(t, `out = char(false)`, nil, runtime.UndefinedValue)
	expectRun(t, `out = char('8')`, nil, '8')
	expectRun(t, `out = char([1,8.1,true,3])`, nil, runtime.UndefinedValue)
	expectRun(t, `out = char({a: 1, b: "foo"})`, nil, runtime.UndefinedValue)
	expectRun(t, `out = char(undefined)`, nil, runtime.UndefinedValue)
	...
	expectRun(t, `out = char(undefined, undefined)`, nil, runtime.UndefinedValue)
	...
	expectRun(t, `out = bytes(1.8)`, nil, runtime.UndefinedValue)
	expectRun(t, `out = bytes("-522")`, nil, []byte{'-', '5', '2', '2'})
	expectRun(t, `out = bytes(true)`, nil, runtime.UndefinedValue)
	expectRun(t, `out = bytes(false)`, nil, runtime.UndefinedValue)
	expectRun(t, `out = bytes('8')`, nil, runtime.UndefinedValue)
	expectRun(t, `out = bytes([1])`, nil, runtime.UndefinedValue)
	expectRun(t, `out = bytes({a: 1})`, nil, runtime.UndefinedValue)
	expectRun(t, `out = bytes(undefined)`, nil, runtime.UndefinedValue)
	...
	expectRun(t, `out = bytes(undefined, undefined)`, nil, runtime.UndefinedValue)
	...
	runtime.MaxStringLen = 9
	expectError(t, `format("%s", "1234567890")`,
		nil, "exceeding string size limit")
	runtime.MaxStringLen = 2147483647

	// delete
	expectError(t, `delete()`, nil, runtime.ErrWrongNumArguments.Error())
	expectError(t, `delete(1)`, nil, runtime.ErrWrongNumArguments.Error())
	expectError(t, `delete(1, 2, 3)`, nil, runtime.ErrWrongNumArguments.Error())
	expectError(t, `delete({}, "", 3)`, nil, runtime.ErrWrongNumArguments.Error())
	...
	expectRun(t, `out = delete({}, "")`, nil, runtime.UndefinedValue)
	...
	// splice
	expectError(t, `splice()`, nil, runtime.ErrWrongNumArguments.Error())
	...
	expectError(t, `splice([], 0, immutable({}))`, nil,
		`invalid type for argument 'third'`)
	expectError(t, `splice([], 1)`, nil, runtime.ErrIndexOutOfBounds.Error())
	expectError(t, `splice([1, 2, 3], 0, -1)`, nil,
		runtime.ErrIndexOutOfBounds.Error())
...
func TestBytesN(t *testing.T) {
	curMaxBytesLen := runtime.MaxBytesLen
	defer func() { runtime.MaxBytesLen = curMaxBytesLen }()
	runtime.MaxBytesLen = 10
...
func TestBytes(t *testing.T) {
	...
	expectRun(t, `out = bytes("abcde")[10]`, nil, runtime.UndefinedValue)
}
...
func TestVMErrorUnwrap(t *testing.T) {
	...
	userFunc := func(err error) *runtime.BuiltinFunction {
		return &runtime.BuiltinFunction{Name: "user_func", Value: func(ctx context.Context, args ...runtime.Object) (runtime.Object, error) {
			return nil, err
		}}
	}
	userModule := func(err error) *runtime.BuiltinModule {
		return &runtime.BuiltinModule{
			Attrs: map[string]runtime.Object{
				"afunction": &runtime.BuiltinFunction{
					Name: "afunction",
					Value: func(ctx context.Context, a ...runtime.Object) (runtime.Object, error) {
						return nil, err
					},
				},
			},
...
func TestFunction(t *testing.T) {
	...
	expectRun(t, `f := func(...x) { return x; }; out = f();`,
		nil, &runtime.Array{Value: []runtime.Object{}})
...
func TestIf(t *testing.T) {
	...
	expectRun(t, `if (false) { out = 10 }`, nil, runtime.UndefinedValue)
	...
	expectRun(t, `if (1 > 2) { out = 10 }`, nil, runtime.UndefinedValue)
...
func (o *StringDict) IndexGet(index runtime.Object) (runtime.Object, error) {
	strIdx, ok := index.(*runtime.String)
	if !ok {
		return nil, runtime.ErrInvalidIndexType
	}
...
func (o *StringDict) IndexSet(index, value runtime.Object) error {
	strIdx, ok := index.(*runtime.String)
	if !ok {
		return runtime.ErrInvalidIndexType
	}

	strVal, ok := runtime.ToString(value)
	if !ok {
		return runtime.ErrInvalidIndexValueType
	}
...
func (o *StringCircle) IndexGet(index runtime.Object) (runtime.Object, error) {
	intIdx, ok := index.(*runtime.Int)
	if !ok {
		return nil, runtime.ErrInvalidIndexType
	}
	...
	return &runtime.String{Value: o.Value[r]}, nil
}

func (o *StringCircle) IndexSet(index, value runtime.Object) error {
	intIdx, ok := index.(*runtime.Int)
	if !ok {
		return runtime.ErrInvalidIndexType
	}
...
func (o *StringArray) BinaryOp(
	...
	return nil, runtime.ErrInvalidOperator
}
...
func (o *StringArray) Equals(x runtime.Object) bool {
...
func (o *StringArray) Copy() runtime.Object {
	return &StringArray{
...
func (o *StringArray) IndexGet(index runtime.Object) (runtime.Object, error) {
	intIdx, ok := index.(*runtime.Int)
	if ok {
		if intIdx.Value >= 0 && intIdx.Value < int64(len(o.Value)) {
			return &runtime.String{Value: o.Value[intIdx.Value]}, nil
		}

		return nil, runtime.ErrIndexOutOfBounds
	}
	...
	if ok {
		for vidx, str := range o.Value {
			if strIdx.Value == str {
				return &runtime.Int{Value: int64(vidx)}, nil
			}
		}
...
func (o *StringArray) IndexSet(index, value runtime.Object) error {
	strVal, ok := runtime.ToString(value)
	if !ok {
		return runtime.ErrInvalidIndexValueType
	}
...
func (o *StringArray) Call(
	...
	for i, v := range o.Value {
		if v == s1 {
			return &runtime.Int{Value: int64(i)}, nil
		}
	}
...
func TestIndexable(t *testing.T) {
	...
	expectRun(t, `out = dict["x"]`,
		Opts().Symbol("dict", dict()).Skip2ndPass(), runtime.UndefinedValue)
	...
	expectRun(t, `out = arr["four"]`,
		Opts().Symbol("arr", strArr()).Skip2ndPass(), runtime.UndefinedValue)
...
func (i *StringArrayIterator) Key() runtime.Object {
	return &runtime.Int{Value: int64(i.idx - 1)}
}

func (i *StringArrayIterator) Value() runtime.Object {
	return &runtime.String{Value: i.strArr.Value[i.idx-1]}
}

func (o *StringArray) Iterate() runtime.Iterator {
...
out = {
	...
	expectRun(t, `out = {foo: 5}["bar"]`, nil, runtime.UndefinedValue)
	expectRun(t, `key := "foo"; out = {foo: 5}[key]`, nil, 5)
	expectRun(t, `out = {}["foo"]`, nil, runtime.UndefinedValue)
...
func TestBuiltin(t *testing.T) {
	m := Opts().Module("math",
		&runtime.BuiltinModule{
			Attrs: map[string]runtime.Object{
				"abs": &runtime.BuiltinFunction{
					Name: "abs",
					Value: func(ctx context.Context, a ...runtime.Object) (runtime.Object, error) {
						v, _ := runtime.ToFloat64(a[0])
						return &runtime.Float{Value: math.Abs(v)}, nil
					},
				},
			},
		})
...
`), "Runtime Error: not callable: int\n\tat mod1:3:4\n\tat test:4:1")
	...
	expectRun(t, `out = import("mod0")`,
		Opts().Module("mod0", ``), runtime.UndefinedValue)
	expectRun(t, `out = import("mod0")`,
		...
		&runtime.BuiltinModule{
			Attrs: map[string]runtime.Object{
				"intn": &runtime.BuiltinFunction{
					Name: "abs",
					Value: func(ctx context.Context, a ...runtime.Object) (runtime.Object, error) {
						v, _ := runtime.ToInt64(a[0])
						return &runtime.Int{Value: rand.Int63n(v)}, nil
					},
				},
			},
		})
...
func testAllocsLimit(t *testing.T, src string, limit int64) {
	expectRun(t, src,
		Opts().Skip2ndPass(), runtime.UndefinedValue) // no limit
	expectRun(t, src,
		Opts().MaxAllocs(limit).Skip2ndPass(), runtime.UndefinedValue)
	expectRun(t, src,
		Opts().MaxAllocs(limit+1).Skip2ndPass(), runtime.UndefinedValue)
	if limit > 1 {
		expectError(t, src,
...
b := a.x.c`, nil, runtime.UndefinedValue)
...
b := a.x.y`, nil, runtime.UndefinedValue)
...
func TestSourceModules(t *testing.T) {
	...
	testEnumModule(t, `out = enum.all(0, enum.value)`,
		runtime.UndefinedValue) // non-enumerable: undefined
	...
	testEnumModule(t, `out = enum.at(["one","two","three"], 3)`,
		runtime.UndefinedValue)
	testEnumModule(t, `out = enum.at(["one","two","three"], "1")`,
		runtime.UndefinedValue) // non-int index: undefined
	...
	testEnumModule(t, `out = enum.at({a:"one",b:"two",c:"three"}, "d")`,
		runtime.UndefinedValue)
	testEnumModule(t, `out = enum.at({a:"one",b:"two",c:"three"}, 'a')`,
		runtime.UndefinedValue) // non-string index: undefined
	...
	testEnumModule(t, `out = enum.filter([false,1,0,2], enum.value)`,
		ARR{1, 2})
	testEnumModule(t, `out = enum.filter({}, enum.value)`,
		runtime.UndefinedValue) // non-array: undefined
...
func expectRun(
	...
	if !opts.skip2ndPass {
		...
		case *runtime.Array:
			expectedObj = &runtime.ImmutableArray{Value: eo.Value}
		case *runtime.Map:
			expectedObj = &runtime.ImmutableMap{Value: eo.Value}
		}
...
func traceCompileRun(file *parser.File, symbols map[string]runtime.Object, modules *runtime.ModuleMap, maxAllocs int64) (res map[string]runtime.Object, trace []string, err error) {
	var v *runtime.VM
	...
	globals := make([]runtime.Object, runtime.GlobalsSize)
	...
	tr := &vmTracer{}
	c := runtime.NewCompiler(file.InputFile, symTable, nil, modules, tr)
	err = c.Compile(file)
	trace = append(trace,
		fmt.Sprintf("\n[Compiler Trace]\n\n%s",
			strings.Join(tr.Out, "")))
	...
	v = runtime.NewVM(context.Background(), bytecode, globals, maxAllocs)

	err = v.Run()
	{
		res = make(map[string]runtime.Object)
...
func formatGlobals(globals []runtime.Object) (formatted []string) {
...
func errorObject(v interface{}) *runtime.Error {
	return &runtime.Error{Value: toObject(v)}
}

func toObject(v interface{}) runtime.Object {
	switch v := v.(type) {
	case runtime.Object:
		return v
	case string:
	...
	case int: // for convenience
		return &runtime.Int{Value: int64(v)}
	case bool:
		if v {
	...
	case rune:
		return &runtime.Char{Value: v}
	case byte: // for convenience
		return &runtime.Char{Value: rune(v)}
	case float64:
		return &runtime.Float{Value: v}
	case []byte:
		return &runtime.Bytes{Value: v}
	case MAP:
	...
	case ARR:
		...
		return &runtime.Array{Value: objs}
	case IMAP:
		objs := make(map[string]runtime.Object)
		for k, v := range v {
			objs[k] = toObject(v)
		...
		return &runtime.ImmutableMap{Value: objs}
	case IARR:
		var objs []runtime.Object
		for _, e := range v {
			objs = append(objs, toObject(e))
		...
		return &runtime.ImmutableArray{Value: objs}
	}

	panic(fmt.Errorf("unknown type: %T", v))
}

func objectZeroCopy(o runtime.Object) runtime.Object {
	switch o.(type) {
	case *runtime.Int:
		return &runtime.Int{}
	case *runtime.Float:
	...
	case *runtime.ImmutableArray:
		return &runtime.ImmutableArray{}
	case *runtime.ImmutableMap:
