...
func globalSymbol(name string, index int) *runtime.Symbol {
	return symbol(name, runtime.ScopeGlobal, index)
}

func localSymbol(name string, index int) *runtime.Symbol {
	return symbol(name, runtime.ScopeLocal, index)
}

func freeSymbol(name string, index int) *runtime.Symbol {
	return symbol(name, runtime.ScopeFree, index)
}

func symbolTable() *runtime.SymbolTable {
	return runtime.NewSymbolTable()
}
