...
func GetModuleMap(names ...string) *runtime.ModuleMap {
...
func Func(function any) *runtime.BuiltinFunction {
	if f, ok := Prop(function).get().(*runtime.BuiltinFunction); ok {
		return f
	}
	return nil
}
...
func Prop(property any) *Property {
	...
	case string:
		return &Property{
			get: func() runtime.Object {
				return &runtime.String{Value: v}
			},
		}
	case *string:
		return &Property{
			get: func() runtime.Object { return &runtime.String{Value: *v} },
			set: func(o runtime.Object) error {
				if str, ok := o.(*runtime.String); ok {
					*v = str.Value
					return nil
				}
				return &runtime.ErrInvalidArgumentType{Name: "property", Expected: "string", Found: o.TypeName()}
			},
		}
...
type Property struct {
	get func() runtime.Object
	set func(runtime.Object) error
}

// Get returns the value of the property.
func (prop *Property) Get() runtime.Object {
	return prop.get()
}

// Set sets the value of the property if it is writable.
func (prop *Property) Set(value runtime.Object) error {
	if prop.set == nil {
...
func (prop *Property) CanCall() bool {
	_, ok := prop.get().(*runtime.BuiltinFunction)
	return ok
}

// Call invokes the property as a function if it is callable.
func (prop *Property) Call(ctx context.Context, args ...runtime.Object) (runtime.Object, error) {
	if f, ok := prop.get().(*runtime.BuiltinFunction); ok {
...
func (obj *Object[T]) IndexGet(key runtime.Object) (runtime.Object, error) {
	if k, ok := runtime.ToString(key); ok {
...
func (obj *Object[T]) IndexSet(key runtime.Object, val runtime.Object) error {
	if k, ok := runtime.ToString(key); ok {
		if v, ok := obj.Props[k]; ok {
			return v.Set(val)
		}
