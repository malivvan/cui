...
func TestFuncAIR(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Int{Value: 10})
	require.NoError(t, err)
	require.Equal(t, runtime.UndefinedValue, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncAR(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, runtime.UndefinedValue, ret)
	_, err = funcCall(uf, runtime.TrueValue)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncARI(t *testing.T) {
	...
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, &runtime.Int{Value: 10}, ret)
	_, err = funcCall(uf, runtime.TrueValue)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncARE(t *testing.T) {
	...
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, runtime.TrueValue, ret)
	uf = stdlib.FuncARE(func() error { return errors.New("some error") })
	ret, err = funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, &runtime.Error{
		Value: &runtime.String{Value: "some error"},
	}, ret)
	_, err = funcCall(uf, runtime.TrueValue)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncARIsE(t *testing.T) {
	...
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, array(&runtime.Int{Value: 1},
		&runtime.Int{Value: 2}, &runtime.Int{Value: 3}), ret)
	uf = stdlib.FuncARIsE(func() ([]int, error) {
...
func TestFuncARS(t *testing.T) {
	...
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, &runtime.String{Value: "foo"}, ret)
	_, err = funcCall(uf, runtime.TrueValue)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncARSs(t *testing.T) {
	...
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, array(&runtime.String{Value: "foo"},
		&runtime.String{Value: "bar"}), ret)
	_, err = funcCall(uf, runtime.TrueValue)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncASRE(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.String{Value: "foo"})
	require.NoError(t, err)
	require.Equal(t, runtime.TrueValue, ret)
...
func TestFuncASRSs(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.String{Value: "foo"})
	require.NoError(t, err)
	require.Equal(t, array(&runtime.String{Value: "foo"}), ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncASI64RE(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.String{Value: "foo"}, &runtime.Int{Value: 5})
	require.NoError(t, err)
	require.Equal(t, runtime.TrueValue, ret)
	...
	require.NoError(t, err)
	require.Equal(t,
		&runtime.Error{Value: &runtime.String{Value: "some error"}}, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncAIIRE(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Int{Value: 5}, &runtime.Int{Value: 7})
	require.NoError(t, err)
	require.Equal(t, runtime.TrueValue, ret)
...
func TestFuncASSRE(t *testing.T) {
	...
	require.Equal(t,
		&runtime.Error{Value: &runtime.String{Value: "some error"}}, ret)
	_, err = funcCall(uf, &runtime.String{Value: "foo"})
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncASsRS(t *testing.T) {
	...
	ret, err := funcCall(uf, array(&runtime.String{Value: "foo"},
		&runtime.String{Value: "bar"}), &runtime.String{Value: " "})
	require.NoError(t, err)
	require.Equal(t, &runtime.String{Value: "foo bar"}, ret)
	_, err = funcCall(uf, &runtime.String{Value: "foo"})
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncARF(t *testing.T) {
	...
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, &runtime.Float{Value: 10.0}, ret)
	_, err = funcCall(uf, runtime.TrueValue)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncAFRF(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Float{Value: 10.0})
	require.NoError(t, err)
	require.Equal(t, &runtime.Float{Value: 10.0}, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
	_, err = funcCall(uf, runtime.TrueValue, runtime.TrueValue)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncAIRF(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Int{Value: 10.0})
	require.NoError(t, err)
	require.Equal(t, &runtime.Float{Value: 10.0}, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
...
func TestFuncAFRI(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Float{Value: 10.5})
	require.NoError(t, err)
	require.Equal(t, &runtime.Int{Value: 10}, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
...
func TestFuncAFRB(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Float{Value: 0.1})
	require.NoError(t, err)
	require.Equal(t, runtime.TrueValue, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
...
func TestFuncAFFRF(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Float{Value: 10.0},
		&runtime.Float{Value: 20.0})
	require.NoError(t, err)
	require.Equal(t, &runtime.Float{Value: 30.0}, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
	_, err = funcCall(uf, runtime.TrueValue)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
...
func TestFuncASIRS(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.String{Value: "ab"}, &runtime.Int{Value: 2})
	require.NoError(t, err)
	require.Equal(t, &runtime.String{Value: "abab"}, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
	_, err = funcCall(uf, runtime.TrueValue)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
...
func TestFuncAIFRF(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Int{Value: 10}, &runtime.Float{Value: 20.0})
	require.NoError(t, err)
	require.Equal(t, &runtime.Float{Value: 30.0}, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
...
func TestFuncAFIRF(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Float{Value: 10.0}, &runtime.Int{Value: 20})
	require.NoError(t, err)
	require.Equal(t, &runtime.Float{Value: 30.0}, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
...
func TestFuncASSIRSs(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.String{Value: "foo"},
		&runtime.String{Value: "bar"}, &runtime.Int{Value: 5})
	require.NoError(t, err)
	require.Equal(t, array(&runtime.String{Value: "foo"},
		&runtime.String{Value: "bar"}, &runtime.String{Value: "5"}), ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncARYE(t *testing.T) {
	...
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, &runtime.Bytes{Value: []byte("foo bar")}, ret)
	uf = stdlib.FuncARYE(func() ([]byte, error) {
		return nil, errors.New("some error")
	})
	ret, err = funcCall(uf)
...
func TestFuncASRIE(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.String{Value: "foo"})
	require.NoError(t, err)
	require.Equal(t, &runtime.Int{Value: 5}, ret)
...
func TestFuncAYRIE(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Bytes{Value: []byte("foo")})
	require.NoError(t, err)
	require.Equal(t, &runtime.Int{Value: 5}, ret)
...
func TestFuncASSRI(t *testing.T) {
	...
	ret, err := funcCall(uf,
		&runtime.String{Value: "foo"}, &runtime.String{Value: "bar"})
	require.NoError(t, err)
	require.Equal(t, &runtime.Int{Value: 6}, ret)
	_, err = funcCall(uf, &runtime.String{Value: "foo"})
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncASSRS(t *testing.T) {
	...
	ret, err := funcCall(uf,
		&runtime.String{Value: "foo"}, &runtime.String{Value: "bar"})
	require.NoError(t, err)
	require.Equal(t, &runtime.String{Value: "foobar"}, ret)
	_, err = funcCall(uf, &runtime.String{Value: "foo"})
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncASSRB(t *testing.T) {
	...
	ret, err := funcCall(uf,
		&runtime.String{Value: "123"}, &runtime.String{Value: "12"})
	require.NoError(t, err)
	require.Equal(t, runtime.TrueValue, ret)
	_, err = funcCall(uf, &runtime.String{Value: "foo"})
	require.Equal(t, runtime.ErrWrongNumArguments, err)
...
func TestFuncAIRS(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Int{Value: 55})
	require.NoError(t, err)
	require.Equal(t, &runtime.String{Value: "55"}, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncAIRIs(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Int{Value: 55})
	require.NoError(t, err)
	require.Equal(t, array(&runtime.Int{Value: 55}, &runtime.Int{Value: 55}), ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncARI64(t *testing.T) {
	...
	ret, err := funcCall(uf)
	require.NoError(t, err)
	require.Equal(t, &runtime.Int{Value: 55}, ret)
	_, err = funcCall(uf, &runtime.Int{Value: 55})
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncASsSRS(t *testing.T) {
	...
	ret, err := funcCall(uf,
		array(&runtime.String{Value: "abc"}, &runtime.String{Value: "def"}),
		&runtime.String{Value: "-"})
	require.NoError(t, err)
	require.Equal(t, &runtime.String{Value: "abc-def"}, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}
...
func TestFuncAI64RI64(t *testing.T) {
	...
	ret, err := funcCall(uf, &runtime.Int{Value: 55})
	require.NoError(t, err)
	require.Equal(t, &runtime.Int{Value: 110}, ret)
	_, err = funcCall(uf)
	require.Equal(t, runtime.ErrWrongNumArguments, err)
}

func funcCall(
	fn runtime.CallableFunc,
	args ...runtime.Object,
) (runtime.Object, error) {
	userFunc := &runtime.BuiltinFunction{Value: fn}
	return userFunc.Call(context.Background(), args...)
}

func array(elements ...runtime.Object) *runtime.Array {
	return &runtime.Array{Value: elements}
}
