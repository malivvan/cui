...
func (d *decodeState) value() (runtime.Object, error) {
	switch d.opcode {
	default:
		panic(phasePanicMsg)
	case scanBeginArray:
...
func (d *decodeState) array() (runtime.Object, error) {
	var arr []runtime.Object
	for {
	...
	return &runtime.Array{Value: arr}, nil
}

func (d *decodeState) object() (runtime.Object, error) {
	...
	return &runtime.Map{Value: m}, nil
}

func (d *decodeState) literal() (runtime.Object, error) {
	...
	default: // number
		...
		return &runtime.Float{Value: n}, nil
	}
}
