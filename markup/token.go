...
// a slice of Attrs. Data is unescaped for all Tokens (it looks like "a<b"
...
// one cannot close the implicit element when parsing a <select>'s Inner
...
// Token returns the current Token. The result's Tag and Attrs values remain
