...
func (v *Variable) Value() interface{} {
	return runtime.ToInterface(v.value)
}
...
func (v *Variable) Array() []interface{} {
	...
	case *runtime.Array:
		...
		for _, e := range val.Value {
			arr = append(arr, runtime.ToInterface(e))
		}
		return arr
	}
	return nil
...
func (v *Variable) Bytes() []byte {
	c, _ := runtime.ToByteSlice(v.value)
	return c
}
...
func (v *Variable) Object() runtime.Object {
	return v.value
}

// IsUndefined returns true if the underlying value is undefined.
func (v *Variable) IsUndefined() bool {
	return v.value == runtime.UndefinedValue
}
