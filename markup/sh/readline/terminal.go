...
import (
	...
	"github.com/malivvan/cui/markup/sh/readline/ansi"
	"github.com/malivvan/cui/markup/sh/readline/platform"
)
...
func (t *terminal) consumeANSIEscape(buf *bufio.Reader, ansiBuf *bytes.Buffer) (result readResult, err error) {
	...
	case '\x1b':
		// Alt plus a real ANSI escape sequence. HandleMessage this specially since
